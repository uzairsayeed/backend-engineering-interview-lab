...
class ShortUrlService:
    ...
    def __init__(
        ...
        reserved_short_codes: Collection[str] = (RESERVED_SHORT_CODES),
    ) -> None:
        ...
        self._reserved_short_codes = frozenset(
            code.casefold() for code in reserved_short_codes
        )
    ...
    def resolve_url(self, short_code: str) -> ShortUrl:
        ...
        logger.debug(
            "short_url_resolved short_code=%s redirect_count=%s",
